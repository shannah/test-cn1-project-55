...
package com.github.shannah.testcn1project55;
 ...
 * @author Shai Almog
 */
public class TestCn1Project55Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Test Cn1 Project 55";
    private static final String APP_NAME = "test-cn1-project-55";
    ...
    private TestCn1Project55 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestCn1Project55Stub());
    }
